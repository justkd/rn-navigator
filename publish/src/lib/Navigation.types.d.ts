 ...
 */
export interface NavigationControllerProps<R extends string | number | symbol, B> extends PropsWithChildren {
    /**
     * Provide the `navigationRoutes` object generated by `getTypedRoutes`.
     */
    routes: Record<R, ComponentType>;
    /**
     * The initial route to show. This will also be the target route when
 ...
 */
export type UseNavigationReturnType<R extends string | number | symbol, B extends string | number | symbol> = {
    /**
